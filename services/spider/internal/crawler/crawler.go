...
type CrawlerConfig struct {
	...
	Policy         *FetchPolicyManager // Domain/robots/politeness policy manager
	Budget         *CrawlBudgetManager // Crawl budget controls
	Metrics        *SpiderMetrics      // Spider metrics collector
}
